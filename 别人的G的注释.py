...
class Generator(object):
    ...
    def __init__(self, num_emb, batch_size, emb_dim, hidden_dim,
        ...
        with tf.variable_scope('generator'):
            ...
            self.g_recurrent_unit = self.create_recurrent_unit(self.g_params)  # maps h_tm1 to h_t for generator 一个完整的lstm
            self.g_output_unit = self.create_output_unit(self.g_params)  # maps h_t to o_t (output token logits) 一个完整的output单元？
